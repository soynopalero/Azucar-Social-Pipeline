...
_Generated 2026-09-19 09:15 PDT by `code/analyze_insights.py`. Numbers come from the Meta Graph API, joined to `posts_queue.json`._

## What this is built on

- **157** published posts with metrics, of 321 marked posted in the queue
- **1703** Instagram posts and **0** Facebook posts on file
- **2** daily account snapshots
...
| 10-19 posts | 61 | 136 (-69%) | 3.2% |
| 20+ posts | 83 | 123 (-72%) | 2.5% |
...
|---|---:|---:|---:|
| cadence_the_bikini_bottoms | 4 | 234 | 7.8% |
| cadence_furanium_fever | 15 | 231 | 3.9% |
| cadence_emo_night_drag_show_edition | 4 | 202 | 5.8% |
| cadence_end_of_summer_blackout_party | 12 | 170 | 2.9% |
| cadence_industry_night_drag_show | 9 | 155 | 4.2% |
| cadence_mosh_night | 5 | 154 | 3.9% |
| cadence_dolly_parton__a_drag_tribute_night | 16 | 150 | 2.8% |
| cadence_heels_dance_class_with_frankie | 8 | 138 | 3.6% |
| cadence_american_horror_story_viewing_party_and_drag_show | 7 | 132 | 3.4% |
| cadence_night_of_kings__an_all_king_drag_show | 20 | 130 | 2.3% |
| cadence_heels_dance_class_with_kimora | 10 | 119 | 1.7% |
| cadence_vida_amore_divas_show_fiesta_patrias | 11 | 117 | 2.2% |
| cadence_an_open_stage_drag_debut | 10 | 112 | 3.1% |
| cadence_drag_king_kareoke | 9 | 112 | 3.8% |
| cadence_sip_and_paint_with_artwithaubrey | 16 | 107 | 1.2% |
...
| 713 | 3.1% | instagram | Sep 10, 19:00 | Summer's saying goodbye and Azucar's throwing it a Blackout Party it'l |
...
| 560 | 4.1% | instagram | Sep 05, 11:00 | The stage is EMPTY and that's exactly the point. 🎤✨ Azúcar is throwing |
...
| Reach | Eng. rate | Platform | When | Opening line |
|---:|---:|---|---|---|
| 42 | 0.0% | instagram | Sep 18, 11:00 | Heels clicking on the Main Floor. Mirror wall catching every angle. Ki |
...
| 68 | 0.0% | instagram | Sep 10, 19:00 | Dim lights, midnight-blue canvas, a moon glowing right where Aubrey te |
| 68 | 0.0% | instagram | Sep 11, 11:00 | Come as you are — paint-stained hands optional, good energy required.  |
